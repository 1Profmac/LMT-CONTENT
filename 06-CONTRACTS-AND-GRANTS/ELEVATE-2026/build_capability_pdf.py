...
pdf.multi_cell(col_w, 3.5,
    '50+TechBridge delivers Digital Pioneer gatherings that teach AI skills to adults 50+. '
...
metrics = [
    ('In-person locations', '9'),
    ('Austin Public Library branches', '6'),
    ('Senior centers', 'AARP-affiliated'),
    ('Veterans programs', 'Foundation Communities'),
    ('City of Austin grant', 'Nexus recipient'),
    ('AI-powered workflows', '30+'),
    ('Certification', 'Texas MBE'),
    ('Workforce', 'WIOA-eligible'),
]
...
diffs = [
    ('50+ AI five-step method', ' - First-timer sessions; we do not claim to be the only program'),
...
align_items = [
    ('2+ yrs Austin production', 'Active since 2024, 9 locations'),

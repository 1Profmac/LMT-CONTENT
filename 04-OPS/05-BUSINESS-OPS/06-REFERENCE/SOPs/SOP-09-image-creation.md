...
- **General asset** → `05-ASSETS/IMAGES/`
- **Thumbnail** → `05-ASSETS/THUMBNAILS/`
- **HeyGen background** → `05-ASSETS/HEYGEN/BACKGROUNDS/`
- If the folder doesn't exist → save to `05-ASSETS/IMAGES/` and note it
